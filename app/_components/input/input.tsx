...
const getVariantClasses = (variant: InputVariant): string => {
  const variants = {
    ...
    error: 'border-red-500 focus:border-red-500 focus:ring-red-500 text-red-900 placeholder-red-300',
    success: 'border-green-500 focus:border-green-500 focus:ring-green-500 text-green-900',
    ghost: 'border-transparent focus:border-blue-500 focus:ring-blue-500 bg-gray-50 hover:bg-gray-100',
  }
...
export const Input = forwardRef<HTMLInputElement, InputProps>(({
  ...
  const baseClasses = 'block w-full rounded-md border bg-white shadow-sm transition-colors focus:outline-none focus:ring-1 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500'
